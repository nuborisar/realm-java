...
import io.realmox.entities.ConflictingFieldName;
import io.realmox.entities.CustomMethods;
import io.realmox.entities.CyclicType;
import io.realmox.entities.Dog;
import io.realmox.entities.NullTypes;
import io.realmox.entities.StringAndInt;
...
import io.realmox.entities.Thread;
...
public class RealmObjectTests {
    ...
    public void get_set_nonNullValueOnNullableFields() {
        ...
        // 2 Bytes
        ExtraTests.assertArrayEquals(testBytes, nullTypes.getFieldBytesNull());
        // 3 Boolean
    ...
    public void defaultValuesForNewObject() {
        ...
        assertNull(nullTypes.getFieldStringNull());
        // 2 Bytes
        ExtraTests.assertArrayEquals(new byte[0], nullTypes.getFieldBytesNotNull());
        assertNull(nullTypes.getFieldByteNull());
        // 3 Boolean
