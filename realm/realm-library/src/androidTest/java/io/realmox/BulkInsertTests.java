...
import io.realmox.entities.AnimalModule;
import io.realmox.entities.Cat;
import io.realmox.entities.CatOwner;
...
import io.realmox.entities.HumanModule;
import io.realmox.entities.NoPrimaryKeyWithPrimaryKeyObjectRelation;
...
import io.realmox.entities.PrimaryKeyWithNoPrimaryKeyObjectRelation;
import io.realmox.entities.pojo.AllTypesRealmModel;
import io.realmox.entities.pojo.InvalidRealmModel;
import io.realmox.exceptions.RealmException;
import io.realmox.exceptions.RealmPrimaryKeyConstraintException;
import io.realmox.internal.modules.CompositeMediator;
import io.realmox.internal.modules.FilterableMediator;
import io.realmox.rule.TestRealmConfigurationFactory;
import io.realmox.internal.test.ExtraTests;
...
public class BulkInsertTests {
    ...
    public void insert() {
        ...
        ExtraTests.assertArrayEquals(allTypes.getFieldBinary(), realmTypes.getFieldBinary());
    ...
    public void insert_realmModel() {
        ...
        ExtraTests.assertArrayEquals(allTypes.columnBinary, first.columnBinary);
    ...
    public void insertOrUpdate() {
        ...
        ExtraTests.assertArrayEquals(new byte[]{2, 3, 4}, obj.getColumnBinary());
