...
import io.realmox.exceptions.RealmMigrationNeededException;
import io.realmox.internal.ColumnIndices;
import io.realmox.internal.ColumnInfo;
import io.realmox.internal.RealmObjectProxy;
import io.realmox.internal.RealmProxyMediator;
import io.realmox.internal.Table;
import io.realmox.internal.Util;
...
public final class Realm extends BaseRealm {
    ...
    /**
     * Realm static constructor that returns the Realm instance defined by the {@link RealmConfiguration} set
    ...
    /**
     * Realm static constructor that returns the Realm instance defined by provided {@link RealmConfiguration}
     *
    ...
    /**
     * Sets the {@link RealmConfiguration} used when calling {@link #getDefaultInstance()}.
     *
     * @param configuration the {@link RealmConfiguration} to use as the default configuration.
     * @throws IllegalArgumentException if a null {@link RealmConfiguration} is provided.
     * @see RealmConfiguration for details on how to configure a Realm.
     */
     ...
     * @return created or updated {@link RealmObject}.
     * @throws java.lang.IllegalArgumentException if trying to update a class without a
     *         {@link io.realm.annotations.PrimaryKey}.
     ...
     *
     * @param object the {@link RealmObject} to copy to the Realm.
     ...
     * set to their default value if not provided.
     *
     * @param object {@link RealmObject} to copy or update.
     ...
     * @throws RealmException if any of the objects has already been added to Realm.
     ...
     * @throws IllegalStateException if the corresponding Realm is closed, called from an incorrect thread or not in a
     * transaction.
     * @throws RealmPrimaryKeyConstraintException if two objects with the same primary key is
     ...
     *
     * @param transaction the {@link Realm.Transaction} to execute.
     ...
     *
     * @param transaction {@link Realm.Transaction} to execute.
     ...
     * @see RealmConfiguration.Builder#modules(Object, Object...)
     */
