...
import io.realmox.internal.RealmCore;
...
import io.realmox.rx.RealmObservableFactory;
import io.realmox.rx.RxObservableFactory;
 ...
 * <p>
 * Instances of a RealmConfiguration can only created by using the {@link RealmConfiguration.Builder} and calling
 * its {@link RealmConfiguration.Builder#build()} method.
 * <p>
 * A commonly used RealmConfiguration can easily be accessed by first saving it as
 * {@link Realm#setDefaultConfiguration(RealmConfiguration)} and then using {@link Realm#getDefaultInstance()}.
 * <p>
...
public final class RealmConfiguration {
    ...
    public static final class Builder {
         ...
         * {@link RealmMigrationNeededException}.
         *
        ...
        /**
         * Sets the {@link RealmMigration} to be run if a migration is needed. If this migration fails to
         * upgrade the on-disc schema to the runtime schema, a {@link RealmMigrationNeededException}
         * will be thrown.
         */
         ...
         * {@link RealmMigrationNeededException} the on-disc Realm will be cleared and recreated
        ...
        /**
         * Sets the initial data in {@link Realm}. This transaction will be executed only for the first time
