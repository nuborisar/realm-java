 ...
 * The schema for a Realm is defined by all classes in a project that extend {@link RealmObject}
 * or implement {@link RealmModel}, so any changes to these classes will require a migration.
 * <p>
 ...
 * {@link Realm#deleteRealm(RealmConfiguration)}. This will delete the database file and eliminate the need for
 * any migrations.
 *
 * @see RealmConfiguration.Builder#schemaVersion(long)
 * @see RealmConfiguration.Builder#migration(RealmMigration)
 * @see RealmConfiguration.Builder#deleteRealmIfMigrationNeeded()
 */
