...
/**
 * DynamicRealm is a dynamic variant of {@link Realm}. This means that all access to data and/or queries are
 ...
 * <p>
 * The same {@link RealmConfiguration} can be used to open a Realm file in both dynamic and typed mode, but
...
public final class DynamicRealm extends BaseRealm {
     ...
     * {@link RealmConfiguration}. Dynamic Realms do not care about schemaVersion and schemas, so opening a
     ...
     *
     * @param transaction {@link DynamicRealm.Transaction} to execute.
