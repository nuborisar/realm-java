...
/**
 * RealmList is used to model one-to-many relationships in a {@link RealmObject}.
 ...
 * underlying Realm is updated, and can only be accessed using the getter of a {@link RealmObject}.
 * <p>
...
public final class RealmList<E extends RealmModel> extends AbstractList<E> implements OrderedRealmCollection<E> {
     ...
     * <p>
     * Use {@link Realm#copyToRealm(Iterable)} to properly persist its elements in Realm.
     */
    public RealmList() {
        managedMode = false;
     ...
     * <p>
     * Use {@link Realm#copyToRealm(Iterable)} to properly persist all unmanaged elements in Realm.
     *
    ...
    /**
     * Checks if the {@link RealmList} is managed by Realm and contains valid data i.e., the {@link Realm}
