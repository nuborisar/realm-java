 ...
 *
 * @see RealmQuery#equalTo(String, String, Case)
 * @see RealmQuery#contains(String, String, Case)
 * @see RealmQuery#beginsWith(String, String, Case)
 * @see RealmQuery#endsWith(String, String, Case)
 */
public enum Case {
    SENSITIVE(true),
    INSENSITIVE(false);
