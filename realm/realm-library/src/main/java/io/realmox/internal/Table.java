...
package io.realmox.internal;

import java.io.Closeable;
import java.util.Date;
import java.util.concurrent.atomic.AtomicInteger;

import io.realmox.RealmFieldType;
import io.realmox.Sort;
...
public class Table implements TableOrView, TableSchema, Closeable {
     ...
     * @throws {@link RealmException} if it is not possible to set the primary key due to the column
