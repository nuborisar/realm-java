...
public class RealmProcessorTest {
    ...
    private JavaFileObject simpleProxy = JavaFileObjects.forResource("io/realmox/SimpleRealmProxy.java");
    private JavaFileObject allTypesModel = JavaFileObjects.forResource("some/test/AllTypes.java");
    private JavaFileObject allTypesProxy = JavaFileObjects.forResource("io/realmox/AllTypesRealmProxy.java");
    private JavaFileObject allTypesDefaultModule = JavaFileObjects.forResource("io/realmox/RealmDefaultModule.java");
    private JavaFileObject allTypesDefaultMediator = JavaFileObjects.forResource("io/realmox/RealmDefaultModuleMediator.java");
    private JavaFileObject booleansModel = JavaFileObjects.forResource("some/test/Booleans.java");
    private JavaFileObject booleansProxy = JavaFileObjects.forResource("io/realmox/BooleansRealmProxy.java");
    ...
    private JavaFileObject nullTypesProxy = JavaFileObjects.forResource("io/realmox/NullTypesRealmProxy.java");
