    ...
    public static some.test.AllTypes createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (update) {
            ...
            if (rowIndex != TableOrView.NO_MATCH) {
                obj = new AllTypesRealmProxy(realm.schema.getColumnInfo(some.test.AllTypes.class));
        ...
        if (obj == null) {
            if (json.has("columnString")) {
                if (json.isNull("columnString")) {
                    obj = (AllTypesRealmProxy) realm.createObject(some.test.AllTypes.class, null);
                } else {
                    obj = (AllTypesRealmProxy) realm.createObject(some.test.AllTypes.class, json.getString("columnString"));
                }
            } else {
                obj = (AllTypesRealmProxy) realm.createObject(some.test.AllTypes.class);
            }
        }
        if (json.has("columnString")) {
            if (json.isNull("columnString")) {
    ...
    public static some.test.AllTypes copyOrUpdate(Realm realm, some.test.AllTypes object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            ...
            if (canUpdate) {
                ...
                if (rowIndex != TableOrView.NO_MATCH) {
                    realmObject = new AllTypesRealmProxy(realm.schema.getColumnInfo(some.test.AllTypes.class));
